...
This helps reduce hosting costs, because the entire blog can be cached in a CDN 
...
I reached for NextJS [^ nextjs] because I knew this webapp would have a relatively
