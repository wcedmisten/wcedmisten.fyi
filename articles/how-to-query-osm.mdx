...
* Rate limits - since the service is provided to the public for free,
it has limitations on the size and duration of each request.
  ...
  * Just for context, this means we can find all Italian restaurants in Virginia,
    but not in the whole US
