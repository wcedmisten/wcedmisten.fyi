...
I was curious to know if there were other devices that haven't gotten the publicity yet.
But after some research, I found that the public data available was insufficient to answer my questions.
...
### How many non-recalled devices are predicated on a recalled device?
