...
thumbnailAlt: ""
description: "What I found uncovering medical device data from the FDA's 510k database."
...
The documentary made me want to know if there could be other devices like this
that haven't gotten the publicity yet, but I found that there was no public
...
more authority to regulate food and drugs, and requiring a pre-market 
