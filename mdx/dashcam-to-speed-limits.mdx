...
![US South OSM Dataset Boundaries](/dashcam-to-speed-limits/us-south-boundaries.png)
...
![Farley Nuclear Plant in OSM](/dashcam-to-speed-limits/nuclear-plant.png)
...
![Dashcam GPX Track Overlayed on Road](/dashcam-to-speed-limits/gpx-track-overlayed.png)
...
![Speed Limit Missing from East Stuart Drive](/dashcam-to-speed-limits/no-speed-limit.png)
